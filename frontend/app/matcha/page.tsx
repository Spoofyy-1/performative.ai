...
export default function MatchaDetector() {
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-4xl mx-auto">
          {!imagePreview ? (
            ...
            <div
              {...getRootProps()}
              className={`drop-zone border-2 border-dashed border-gray-300 rounded-xl p-12 text-center cursor-pointer transition-all hover:border-green-400 hover:bg-green-50 ${
                isDragActive ? 'active' : ''
              }`}
            >
              <input {...getInputProps()} />
                        ...
                        <div className="w-full bg-gray-200 rounded-full h-3">
                          <div 
                            className={`h-3 rounded-full ${
                              analysis.isMatcha ? 'bg-green-500' : 'bg-red-500'
                            }`}
        ...
        <div className="text-center mt-12 text-gray-500">
          <p>Powered by OpenAI Vision API • Part of Performative.AI</p>
        </div>
      </div>
    </main>
  )
